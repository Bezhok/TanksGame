...
//rude level generation
public class Levels {
    private final int levelsCount = 3;
    private final String greenTank = "tank2.png";
    private final String yellowTank = "tank3.png";
    ...
    public void loadNext(InputHandler inputHandler) {
        ...
        for (var obj : Main.staticGameObjects) {
            obj.start();
        }
    ...
    private void level3(InputHandler inputHandler) {
        ...
        Main.staticGameObjects.add(wall1);
    ...
    private void level2(InputHandler inputHandler) {
        ...
        Main.staticGameObjects.add(wall4);
        Main.staticGameObjects.add(wall5);
        Main.staticGameObjects.add(wall1);
        Main.staticGameObjects.add(wall2);
        Main.gameObjectsBuffer.add(player);
        Main.gameObjectsBuffer.add(enemy1);
        Main.gameObjectsBuffer.add(enemy2);
        Main.gameObjectsBuffer.add(enemy3);
